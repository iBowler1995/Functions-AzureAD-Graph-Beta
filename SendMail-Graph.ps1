function SendMail-Graph {
    ...
    If ($Attachment){
        ...
        Try {
            ...
            Invoke-RestMethod -Uri "https://graph.microsoft.com/beta/users/$from/sendMail" -Method POST -Headers $Header -Body $Json -ContentType "application/json"
            ...
            Write-Error "Error at line $Line`: $ResponseBody"
        }
