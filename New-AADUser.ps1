function New-AADUser {
    ...
    If ($Mobile) {
        ...
        Update-AADUser -UPN $UPN -FName $FName -LName $LName -Company "Verisma Systems, Inc." -Title $Title -Office $Office -Manager $Manager -Dept $Dept -Mobile $Mobile -Location | out-null

    }
    else{

        Update-AADUser -UPN $UPN -FName $FName -LName $LName -Company "Verisma Systems, Inc." -Title $Title -Office $Office -Manager $Manager -Dept $Dept -Location | out-null
