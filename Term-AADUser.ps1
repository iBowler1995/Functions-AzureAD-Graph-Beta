function Term-AADUser {
    ...
    function Remove-AADGroupMember {
        ...
        If ($all){
            ...
            $GroupsUri = "https://graph.microsoft.com/beta/users/$($User.Id)/transitiveMemberOf"
            ...
            foreach ($Item in $Groups.value){
                ...
                $RemoveFromUri = "https://graph.microsoft.com/beta/groups/$($RemoveFrom.Id)/members/$($UsertoRemove.Id)/`$ref"
                Try{
    ...
    function Remove-AADUserLicense {
        ...
        If ($All) {
            ...
            $detailUri = "https://graph.microsoft.com/beta/users/$UPN/licenseDetails"
    ...
    $displayUri = "https://graph.microsoft.com/beta/users/$UPN"
    $displayBody = @{
    ...
    Write-Host "Removing $UPN from all Teams..." -f White
    Try {

        Remove-AADUserFromTeam -UPN $UPN -All
        Write-Host "$UPN removed from all $Teams." -f Green
        Write-Host "============" -f green
